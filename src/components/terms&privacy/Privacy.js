...
export default function Privacy() {
  return (
    <div>
      <h1 style={{ fontWeight: '700', fontSize: '40px', textAlign: 'center' }}>
        Privacy Policy for
        <a
          className='links'
      ...
      <p>
        ...
        recorded by resume and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in resume. This policy is not applicable to any
        information collected offline or via channels other than this website.
        Our Privacy Policy was created with the help of the
        https://www.privacypolicygenerator.info Privacy Policy Generator.
      </p>
      ...
      <p>
        resume follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of resume.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on resume, which are sent directly
      ...
      <p>
        Note that resume has no access to or control over these cookies that are
      ...
      <p>
        resume's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        resume does not knowingly collect any Personal Identifiable Information
